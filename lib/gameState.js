...
// In serverless environments, this may reset on cold starts
if (typeof global !== 'undefined' && !global.__traitorsGameState) {
  console.log('[GAME-STATE] Initializing new game state (cold start detected)');
...
} else if (typeof global !== 'undefined' && global.__traitorsGameState) {
  console.log(`[GAME-STATE] Using existing state: Q${global.__traitorsGameState.currentQuestionIndex + 1}, phase=${global.__traitorsGameState.phase}`);
}
